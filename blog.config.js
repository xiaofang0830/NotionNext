...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Fang', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个乐于搬砖的仙女', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://note.121104.com/', // 网站地址
